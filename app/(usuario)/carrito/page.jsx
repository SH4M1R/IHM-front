    ...
    if (!carrito?.items?.length) return (
        <div className="flex items-center justify-center min-h-[60vh] px-4">
            <div className="text-center max-w-sm">
                ...
                <Link href="/catalogo" className="inline-flex items-center gap-2 bg-yellow-400 hover:bg-yellow-300 text-blue-950 font-black text-sm px-6 py-3 rounded-xl transition-colors">
                    <FiPackage size={16} />
                    Ir al catálogo
                </Link>
            </div>
        ...
        <div className="max-w-4xl mx-auto px-4 py-10">
            ...
            <div className="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-400 font-medium mt-0.5">{totalItems} {totalItems === 1 ? "producto" : "productos"}</p>
                </div>
            </div>
                    ...
                    {carrito.items.map(item => (
                        ...
                        >
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-gray-400 mb-1">{item.producto.categoria || "General"}</p>
                                <div className="flex items-center gap-2">
                                    <span className="text-yellow-500 font-black text-sm">
                                        S/ {item.producto.precio?.toFixed(2)}
                                    </span>
                                    <span className="text-gray-300 text-xs">×</span>
                                    <span className="text-gray-500 text-xs font-medium">{item.cantidad}</span>
                                </div>
                            </div>
